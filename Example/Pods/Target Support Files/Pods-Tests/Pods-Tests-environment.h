...
// TAlertView
#define COCOAPODS_POD_AVAILABLE_TAlertView
#define COCOAPODS_VERSION_MAJOR_TAlertView 0
#define COCOAPODS_VERSION_MINOR_TAlertView 1
#define COCOAPODS_VERSION_PATCH_TAlertView 0
